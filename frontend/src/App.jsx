    ...
    <QueryClientProvider client={qc}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/acesso-negado" element={
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
              <div className="bg-white rounded-2xl p-8 text-center shadow max-w-md">
                ...
                <h1 className="text-xl font-bold text-gray-900 mb-2">Acesso nao permitido</h1>
                <p className="text-gray-500 text-sm mb-4">Seu e-mail nao esta cadastrado no sistema.</p>
          ...
          <Route path="/importacao" element={<RotaProtegida><RotaAdmin><Importacao /></RotaAdmin></RotaProtegida>} />
